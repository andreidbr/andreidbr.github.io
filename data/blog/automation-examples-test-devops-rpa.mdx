...
- [Classic automation 🚗](#classic-automation-)
- [IT Automation layers: from scripts to Artificial Intelligence 💻](#it-automation-layers-from-scripts-to-artificial-intelligence-)
