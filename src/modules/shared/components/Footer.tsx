  ...
  return (
    <footer className="w-full bg-bg-3 py-8 text-center text-xs">
      <span className="text-black">
        © {new Date().getFullYear()} andreidobra.com built with{' '}
...
const socialLinksData = [
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/dobraandrei/',
    path: (
  ...
  {
    label: 'GitHub',
    href: 'https://github.com/andreidbr/',
    path: (
  ...
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/c/AndreiDobra',
    path: (
